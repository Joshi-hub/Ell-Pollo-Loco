...
function createBackgroundLayer(x) {
  ...
  return [
    ...
    new BackgroundObject(
      `img/5_background/layers/3_third_layer/${layerType}.png`,
      x
    ),
    new BackgroundObject(
      `img/5_background/layers/2_second_layer/${layerType}.png`,
      x
    ),
    new BackgroundObject(
      `img/5_background/layers/1_first_layer/${layerType}.png`,
      x
    ),
  ];
}
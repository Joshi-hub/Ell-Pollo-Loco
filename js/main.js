...
/**
 * Title text element used for animated title effect.
 */
const titleElement = document.getElementById("title");

/**
 * Wraps each character of the title text into a span
 * to enable staggered CSS animations.
 */
...
/**
 * Creates a single span element for a title character.
 * 
...
function createTitleChar(character, index) {
  ...
  if (character === " ") {
    titleCharElement.textContent = "\u00A0"; // non-breaking space
  } else {
